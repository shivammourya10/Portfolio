        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-6 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Full-Stack Developer skilled in JavaScript, React, and Node.js with Express to build dynamic, full-featured web applications. Experienced in containerizing applications with Docker and currently expanding my expertise into Generative AI.
            </p>
          </div>
