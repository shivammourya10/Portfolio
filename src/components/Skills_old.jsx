import { Code, Database, Globe, Smartphone, Brain, Users        { name: "Tailwind CSS", icon: "🎨" },
        { name: "MySQL", icon: "🗄️" },
        { name: "C/C++", icon: "⚙️" },from 'lucide-react'
              ...
              {softSkills.map((skill, index) => (
                ...
                >
                  <div className="relative bg-white/10 dark:bg-gray-800/10 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 p-8 rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500">
                    ...
                    <div className="relative z-10">
                      <motion.div 
                        className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-100 to-purple-200 dark:from-primary-900 dark:to-purple-800 rounded-full text-primary-600 dark:text-primary-400 mb-4 shadow-lg"
            ...
            <div className="relative bg-white/10 dark:bg-gray-800/10 backdrop-blur-xl border border-white/20 dark:border-gray-700/20 rounded-2xl p-8 text-center shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  tools, and methodologies to stay current with industry trends and best practices.
                </motion.p>
              </div>
